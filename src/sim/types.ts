...
export type Tower = { id: string; x: number; y: number; stack: Array<Alliance | "white">; stackedBy: Array<number | null>; scoreable: boolean }
export type RobotSnapshot = { id: number; alliance: Alliance; x: number; y: number; angle: number; held: Alliance | "white" | null; action: "idle" | "intake" | "score"; progress: number; active: boolean; maxStackHeight: number }
...
export const DEFAULT_CONFIG: RobotConfig = { translationSpeed: 12, rotationSpeed: 360, intakeSeconds: 0.5, scoreSeconds: 0.75, maxStackHeight: 8 }
export const MAX_STACK_HEIGHT = 20
